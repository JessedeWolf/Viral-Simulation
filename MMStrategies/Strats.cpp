...
namespace corsim
{
    int RegularMovementStrat::move(int dt, std::vector<Subject> &subjects, int week)
    {
    ...
    int LockdownMovementStrat::move(int dt, std::vector<Subject> &subjects, int week)
    {
        if (run == NULL)
        {
    ...
    int SlowdownMovementStrat::move(int dt, std::vector<Subject> &subjects, int week)
    {   
